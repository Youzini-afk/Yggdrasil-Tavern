...
const calendarResult: JsonObject = {
  events: [
    {
          ...
          subs: [
            {
              kind: 'text',
              text:
                "Help me plan tomorrow's product review. Pull the calendar entry " +
          ...
          subs: [
            {
              kind: 'thinking',
              text:
                'I should check the calendar before drafting an agenda. The user ' +
            ...
            },
            {
              kind: 'text',
              text:
                "Here's a 45-minute agenda for tomorrow's product review:\n\n" +
            ...
            },
            {
              kind: 'note',
              text:
                'agenda calibrated to 45m; trim discussion if demo runs over.',
            },
          ],
          meta: {
            model: 'gpt-4o-mini',
