...
export const ST_DARK_V1 = importSTTheme({
    name: 'Dark V 1.0',
    blur_strength: 13,
...
export const ST_AZURE = importSTTheme({
    name: 'Azure',
    blur_strength: 11,
...
export const ST_CELESTIAL_MACARON = importSTTheme({
...
//# sourceMappingURL=built-in-themes.js.map