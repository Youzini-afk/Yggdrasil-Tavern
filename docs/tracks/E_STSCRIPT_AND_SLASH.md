...
这仍是 `partial`。当前已有 STScript parser/evaluator skeleton、pipe、scope、closure、`/let`、`/var`、`/while`、`/break` 和 registry metadata。Quick Reply runtime 深度集成、autocomplete/debugger、全部 153+ commands 和字节级 STScript 行为仍未实现。
