...
- **兼容矩阵**：[`docs/COMPATIBILITY_MATRIX.md`](docs/COMPATIBILITY_MATRIX.md) —— B/C/D/E/F/G/H/I 进入 `partial`，深度移植覆盖 PromptManager / World Info / STScript / macros / chat/text completion / instruct / tokenizer / extensions / ST API / extension loader；Round 4 U-track 已验证 tokenizer 6/6、instruct 2/2、macro 4/4、world-info 4/4 byte-perfect，chat 4/4 cosmetic；Round 5 V-track 已落地 SillyTavern UI parity（9/9 抽屉、ST `.mes` 消息 DOM、1000px + 768px 移动断点）。
