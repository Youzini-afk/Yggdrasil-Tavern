...
Next: establish performance baselines (subprocess JSON-RPC, SSE streaming, prompt construction), advance Phase B pain points (multi-agent orchestration, MCP protocol surface, vector RAG, ToolManager full registration), and complete production bundle hosting. Full documentation index in [`docs/`](docs/README.en.md).
